...
class WatchTowerDB_StreamRecord extends BaseRecord
{
    /**
   ...
   protected function defineAttributes()
    {
        return array(
            ...
            'notifyWho'  => array(AttributeType::String, 'default' => ''),
        );
    }
    ...
    {
        return array(
            'watchtowerdb_logs' => array(static::HAS_MANY, 'WatchTowerDB_LogRecord', 'stream_id'),
        );
    }
}